...
# images_path = "dbs/segmentor_db/raw"  
masks_path = "dbs/segmentor_db/cooked"  

def display_masks(images_path:str, masks_path:str)-> int:
    for filename in tqdm.tqdm(os.listdir(masks_path), desc="Visualizing masks"):
        ...
        npz_path = os.path.join(masks_path, filename)
        try:
