...
def init_sam(model_path:str) -> ultralytics.models.sam.model.SAM:
    ...
    try:
        # Initialize SAM model
        model = ultralytics.SAM(model_path)  # Load MobileSAM model
...
def generate_masks(model:ultralytics.models.sam.model.SAM, input_folder:str, output_folder:str) -> int:
